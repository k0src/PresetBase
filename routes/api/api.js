...
// Stats API routes
router.get("/stats/top-presets", async (req, res) => {
  const query = `
    SELECT
      presets.preset_name,
      synths.synth_name,
...
router.get("/stats/presets-per-synth", async (req, res) => {
  const query = `
    SELECT
      synths.synth_name,
...
router.get("/stats/top-synths", async (req, res) => {
  const query = `
    SELECT
      synths.synth_name,
...
router.get("/stats/synth-time-data", async (req, res) => {
  const query = `
    SELECT 
...
router.get("/stats/heatmap-data", async (req, res) => {
  const query = `
    SELECT
...
router.get("/stats/community-stats", async (req, res) => {
  const queries = {
    totalDbStats: `
      SELECT
        (
