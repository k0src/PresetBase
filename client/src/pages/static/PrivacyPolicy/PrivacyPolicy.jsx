  ...
  return (
    <>
      ...
      <ContentContainer isAuth={true} userIsAdmin={true}>
        ...
        <section className={styles.ppContainer}>
          <p className={styles.bodyText}>Last updated: June 13, 2024</p>
          ...
          <h3 className={styles.headingTertiary}>Interpretation</h3>
          <p className={styles.bodyText}>
          ...
          <h3 className={styles.headingTertiary}>Definitions</h3>
          <p className={styles.bodyText}>
            For the purposes of this Privacy Policy:
          </p>
          <ul className={styles.ppList}>
            <li className={styles.ppListItem}>
              <p className={styles.bodyText}>
            ...
            <li className={styles.ppListItem}>
              <p className={styles.bodyText}>
                ...
                in this Agreement) refers to PresetBase.
              </p>
            </li>
            <li className={styles.ppListItem}>
              <p className={styles.bodyText}>
            ...
            <li className={styles.ppListItem}>
              <p className={styles.bodyText}>
                <strong>Country</strong> refers to: Rhode Island, United States
              </p>
            </li>
            <li className={styles.ppListItem}>
              <p className={styles.bodyText}>
            ...
            <li className={styles.ppListItem}>
              <p className={styles.bodyText}>
                <strong>Website</strong> refers to PresetBase, accessible from
                <a
                  href="https://www.presetbase.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.presetbase.com
                </a>
              </p>
            </li>
            <li className={styles.ppListItem}>
          ...
          <h3 className={styles.headingTertiary}>Types of Data Collected</h3>
          <h4 className={styles.headingQuaternary}>Personal Data</h4>
          <p className={styles.bodyText}>
          ...
          <ul className={styles.ppList}>
            <li className={styles.ppListItem}>Usage Data</li>
          </ul>
          <h4 className={styles.headingQuaternary}>Usage Data</h4>
          <p className={styles.bodyText}>
          ...
          <ul className={styles.ppList}>
            <li className={styles.ppListItem}>Google</li>
            <li className={styles.ppListItem}>Facebook</li>
            <li className={styles.ppListItem}>Instagram</li>
            <li className={styles.ppListItem}>Twitter</li>
            <li className={styles.ppListItem}>LinkedIn</li>
          </ul>
          <p className={styles.bodyText}>
          ...
          <ul className={styles.ppList}>
            <li className={styles.ppListItem}>
              ...
              <p className={styles.bodyText}>Type: Session Cookies</p>
              <p className={styles.bodyText}>Administered by: Us</p>
              <p className={styles.bodyText}>
            ...
            <li className={styles.ppListItem}>
              ...
              <p className={styles.bodyText}>Type: Persistent Cookies</p>
              <p className={styles.bodyText}>Administered by: Us</p>
              <p className={styles.bodyText}>
          ...
          <h3 className={styles.headingTertiary}>Use of Your Personal Data</h3>
          <p className={styles.bodyText}>
          ...
          <h3 className={styles.headingTertiary}>Delete Your Personal Data</h3>
          <p className={styles.bodyText}>
          ...
          <h4 className={styles.headingQuaternary}>Business Transactions</h4>
          <p className={styles.bodyText}>
          ...
          <h4 className={styles.headingQuaternary}>Law enforcement</h4>
          <p className={styles.bodyText}>
          ...
          <h4 className={styles.headingQuaternary}>Other legal requirements</h4>
          <p className={styles.bodyText}>
          ...
          <h2 className={styles.headingSecondary}>Children's Privacy</h2>
          <p className={styles.bodyText}>
          ...
          <h2 className={styles.headingSecondary}>Links to Other Websites</h2>
          <p className={styles.bodyText}>
          ...
          <p className={styles.bodyText}>
            ...
            <Link to="/privacy-policy">
              https://presetbase.com/privacy-policy
            </Link>
          </p>
        </section>
      </ContentContainer>
